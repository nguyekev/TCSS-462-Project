...
time output=`aws lambda invoke --invocation-type RequestResponse --function-name tutorial6sql --region us-east-2 --payload $json /dev/stdout | head -n 1 | head -c -2 ; echo`
